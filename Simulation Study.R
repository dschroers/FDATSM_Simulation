...
########################################################################################################################################################
    ...
    #make projections
  {
    ...
    Proj.M1.price.data <- M1.price.data %*% E1$vectors[,1:3] %*% t(E1$vectors[,1:3])
    Proj.M2.price.data <- M2.price.data %*% E2$vectors[,1:3] %*% t(E2$vectors[,1:3])
    Proj.M3.price.data <- M3.price.data %*% E3$vectors[,1:3] %*% t(E3$vectors[,1:3])
    Proj.M4.price.data <- M4.price.data %*% E4$vectors[,1:3] %*% t(E4$vectors[,1:3])
  }
    ...
    #make projections
    {
      ...
      Cov.Proj.M1.price.data <- M1.price.data %*% E1$vectors[,1:3] %*% t(E1$vectors[,1:3])
      Cov.Proj.M2.price.data <- M2.price.data %*% E2$vectors[,1:3] %*% t(E2$vectors[,1:3])
      Cov.Proj.M3.price.data <- M3.price.data %*% E3$vectors[,1:3] %*% t(E3$vectors[,1:3])
      Cov.Proj.M4.price.data <- M4.price.data %*% E4$vectors[,1:3] %*% t(E4$vectors[,1:3])
    }
